...
public class MallJSInterface {
    ...
    private void setLocation(LatLng latLng) {
        ...
        new Handler(Looper.getMainLooper()).post(() -> webView.loadUrl("javascript:__setLocation({" +
    ...
    public void getSystemInfo() {
        ...
        new Handler(Looper.getMainLooper()).post(() -> webView.loadUrl("javascript:__setSystemInfo({" +
    ...
    public void getSoftKeyboardHeight() {
        ...
        new Handler(Looper.getMainLooper()).post(() -> webView.loadUrl("javascript:__setSoftKeyboardHeight(" + softKeyboardHeight + ")"));
    }

    public void setKeyBoardStatus(String status) {
        new Handler(Looper.getMainLooper()).post(() -> webView.loadUrl("javascript:__setKeyBoardStatus('" + status + "')"));
    }
